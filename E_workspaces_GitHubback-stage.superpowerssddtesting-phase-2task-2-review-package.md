...
### Commit Log
0bb110b test: add unit tests for EcosystemGraphController (4 tests)

### Stat Summary
 .../http/ecosystem-graph.controller.test.ts        | 69 ++++++++++++++++++++++
 1 file changed, 69 insertions(+)

### Full Diff
diff --git a/packages/backend/src/modules/ecosystem/interfaces/http/ecosystem-graph.controller.test.ts b/packages/backend/src/modules/ecosystem/interfaces/http/ecosystem-graph.controller.test.ts
new file mode 100644
index 0000000..4f94653
--- /dev/null
+++ b/packages/backend/src/modules/ecosystem/interfaces/http/ecosystem-graph.controller.test.ts
@@ -0,0 +1,69 @@
