...
### Stat Summary
 .../ecosystem-graph.repository.test.ts             | 131 +++++++++++++++++++++
 1 file changed, 131 insertions(+)

### Full Diff
diff --git a/packages/backend/src/modules/ecosystem/infrastructure/ecosystem-graph.repository.test.ts b/packages/backend/src/modules/ecosystem/infrastructure/ecosystem-graph.repository.test.ts
new file mode 100644
index 0000000..a96d2b4
--- /dev/null
+++ b/packages/backend/src/modules/ecosystem/infrastructure/ecosystem-graph.repository.test.ts
@@ -0,0 +1,131 @@
